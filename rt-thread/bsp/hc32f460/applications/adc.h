 ...
 */
#define ADC1_REMAP_CH               (ADC1_CH0)
#define ADC2_REMAP_CH               (ADC2_CH0 | ADC2_CH1 | ADC2_CH2 | ADC2_CH3 | ADC2_CH4)

#define ADC2_SA_CHANNEL             (ADC2_REMAP_CH)
#define ADC1_SA_CHANNEL             (ADC1_REMAP_CH)
#define ADC1_SA_CHANNEL_COUNT       (1u)
#define ADC2_SA_CHANNEL_COUNT       (5u)
...
#define ADC1_SA_CHANNEL_SAMPLE_TIME {60}
#define ADC2_SA_CHANNEL_SAMPLE_TIME {60,60,60,60,60}
...
#define ADC1_SA_DMA_BLOCK_SIZE		(1u)
...
#define ADC2_SA_DMA_BLOCK_SIZE		(5u)
